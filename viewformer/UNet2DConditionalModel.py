...
class UNet2DConditionModel(
    ...
    def __init__(
        ...
        self.conv_in_image = zero_module(nn.Conv2d(
            in_channels * 3, block_out_channels[0], kernel_size=conv_in_kernel, padding=conv_in_padding
        ))
    ...
    def forward(
        ...
        # 2. pre-process
        sample = self.conv_in(sample) + self.conv_in_image(image)
